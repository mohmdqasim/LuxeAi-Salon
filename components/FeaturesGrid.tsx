      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <ScrollReveal animation="fade-in-up" className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-6 text-primary dark:text-white">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-accent to-secondary">to scale your empire.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-min">
          {features.map((f, idx) => (
            <ScrollReveal
              ...
              animation="zoom-in"
              delay={idx * 100}
              className={`${f.className} group relative overflow-hidden p-8 rounded-[2.5rem] bg-slate-50 dark:bg-slate-900/40 border border-slate-200/50 dark:border-slate-800/50 hover:border-accent/30 dark:hover:border-accent/30 transition-all duration-500 hover:shadow-2xl hover:shadow-accent/5`}
            >
              {/* Background Accent */}
              {f.color && (
              ...
              <div className="relative z-10 h-full flex flex-col">
                <div className="flex justify-between items-start mb-8">
                  <div className="w-14 h-14 bg-white dark:bg-slate-800 rounded-2xl flex items-center justify-center shadow-sm border border-slate-100 dark:border-slate-700 group-hover:scale-110 group-hover:bg-accent group-hover:text-white transition-all duration-500">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-black tracking-tight mb-3 group-hover:translate-x-1 transition-transform duration-300 text-primary dark:text-white">{f.title}</h3>
              ...
              <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-accent/5 rounded-full scale-0 group-hover:scale-100 transition-transform duration-700"></div>
            </ScrollReveal>
          ))}
        </div>
